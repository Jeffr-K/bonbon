...
import { FaShoppingCart, FaUser, FaBars, FaMapMarkerAlt, FaHome, FaBoxOpen, FaInfoCircle } from 'react-icons/fa';
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <>
                ...
                <Link href="/locations" className="text-gray-700 hover:text-amber-600">
              ...
              <button 
                ...
                className="flex items-center space-x-1 px-4 py-2 border border-amber-600 text-amber-800 hover:bg-amber-600 hover:text-white transition-colors"
              >
                <FaUser />
                <span>로그인</span>
              </button>
        ...
        <div className="p-5">
          <div className="flex flex-col">
            ...
            <nav className="mt-4 flex flex-col space-y-4">
              <Link 
                href="/" 
                className="py-3 border-b border-gray-200 text-gray-700 hover:text-amber-600 flex items-center space-x-2"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <FaHome />
                <span>홈</span>
          ...
          <div ref={modalRef} className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-4">
            ...
            <form>
              ...
              <div className="mb-4">
                ...
                <input type="password" id="password" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-amber-500" placeholder="*************" />
              </div>
            </form>
